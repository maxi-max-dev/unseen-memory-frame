...
- **Windows Link 2 设备端**：只包含明确列举并审查的文本源码，来源与后续修改见 `devices/link2-windows/UPSTREAM.md`。官方 Link SDK、外部头文件/库、DLL、EXE、构建产物、私有令牌配置与原始交付压缩包均不随本仓库分发。部署者自行准备 SDK 并遵守上游使用条件。
